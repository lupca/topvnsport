...
export default function Topbar() {
  return (
    <header className="h-16 bg-slate-900 border-b border-slate-800 px-6 flex items-center justify-between sticky top-0 z-40 shadow-sm shadow-slate-950/50">
      {/* Search Input bar */}
      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        <Link href="/orders" className="flex items-center gap-3 hover:opacity-85 transition-opacity cursor-pointer">
          <div className="flex flex-col text-right">
            ...
            <span className="text-[10px] text-slate-500 font-semibold uppercase">PIM Owner</span>
          </div>
