...
interface ProductLogisticsProps {
  showOtherOnly?: boolean;
  showLogisticsOnly?: boolean;
}

export default function ProductLogistics({ showOtherOnly = false, showLogisticsOnly = false }: ProductLogisticsProps = {}) {
  const { register, watch, formState: { errors } } = useFormContext();
  const watchIsPreOrder = watch("is_pre_order");

  const renderLogistics = !showOtherOnly;
  const renderOther = !showLogisticsOnly;
