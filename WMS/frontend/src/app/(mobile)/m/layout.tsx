...
import { Home, Scan, PackageOpen, ArrowDownLeft, Search, Sliders } from "lucide-react";
...
export default function MobileLayout({
  ...
  const navItems = [
    ...
    { name: "Pick", href: "/m/pick", icon: PackageOpen, matchPrefix: "/m/pick" },
    { name: "Pack", href: "/m/pack", icon: Scan, matchPrefix: "/m/pack" },
    { name: "Receive", href: "/m/receive", icon: ArrowDownLeft, matchPrefix: "/m/receive" },
    { name: "Check", href: "/m/stock-check", icon: Sliders, matchPrefix: "/m/stock-check" },
    { name: "Lookup", href: "/m/lookup", icon: Search },
  ];
