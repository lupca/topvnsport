    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 animate-in fade-in duration-300" id="store-locator-page">
      ...
      <div className="text-center mb-10">
        ...
        <h1 className="font-display font-black text-2xl md:text-4xl text-gray-900 tracking-tight mt-3">
          CỬA HÀNG TRẢI NGHIỆM <span className="text-orange-500">TOPVNSPORT</span>
        </h1>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-xs">
            ...
            <div className="flex flex-wrap gap-1.5">
              <span className="text-xs px-3 py-1.5 rounded-full border bg-orange-500 text-white border-orange-500 font-bold">
                Hà Nội
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 scrollbar-hide">
            {branches.map(branch => (
              <div
                ...
                className="p-4 rounded-xl border bg-orange-50/70 border-orange-400 shadow-md ring-1 ring-orange-300 transition-all cursor-pointer"
              >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 mt-2.5 text-[11px] text-gray-400 font-mono">
                      <span className="flex items-center gap-1">
                        <Phone className="w-3 h-3 text-orange-500" /> {branch.phone}
                      </span>
                      <span className="flex items-center gap-1">
                        <Clock className="w-3 h-3 text-orange-500" /> {branch.schedule}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-md overflow-hidden">
            <div className="bg-gray-950 text-white p-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              <div>
                <span className="text-[10px] bg-orange-500 text-white px-2 py-0.5 rounded-sm font-bold uppercase tracking-wider">ĐANG CHỌN TRẢI NGHIỆM</span>
                <h3 className="font-display font-bold text-base mt-1">{activeBranch.name}</h3>
              </div>
              <a
                href={`tel:${activeBranch.phone}`}
                className="bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold px-4 py-2 rounded-full flex items-center gap-1.5 transition"
              >
            ...
            {!isBooked ? (
              <form onSubmit={handleBookDemo} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-850 border border-gray-800 rounded-lg px-3 py-2 text-xs text-white focus:outline-hidden focus:border-orange-500 transition"
                    />
                  </div>
                  <div>
                ...
                <div className="flex justify-end">
                  <button
                    type="submit"
                    className="bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs uppercase tracking-wider px-8 py-3 rounded-full flex items-center gap-1.5 transition glow-btn"
                  >
