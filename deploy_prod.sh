...
write_secret "\$DEPLOY_PATH/PMI/backend/.env.prod" PUBLIC_TENANT_ID <<'PMI_PUBLIC_TENANT_ID_VALUE'
${PUBLIC_TENANT_ID}
PMI_PUBLIC_TENANT_ID_VALUE
write_secret "\$DEPLOY_PATH/PMI/backend/.env.prod" PUBLIC_SELLER_ID <<'PMI_PUBLIC_SELLER_ID_VALUE'
${PUBLIC_SELLER_ID}
PMI_PUBLIC_SELLER_ID_VALUE
